...
class NoisyCat(Cat): # Fill me in!
    ...
    def __init__(self, name, owner, lives=9):
        # Q: Is this method necessary? Why or why not?
        # A: This method is not necessary, we could just call Cat.__init__(name,owner,lives). 
        # We can call this explicitly, or just not have an init method in NoisyCat
        "*** YOUR CODE HERE ***"
