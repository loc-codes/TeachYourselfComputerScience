...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t) and label(t) == 'loki':
        ...
        branchs = [replace_loki_at_leaf(branch, lokis_replacement) for branch in branches(t)]
...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_a = distance(test_city, city_a)
    distance_b = distance(test_city, city_b)
